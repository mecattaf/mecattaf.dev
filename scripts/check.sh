...
test ! -e "$repo_root/dist/_template/index.html"
...
grep -q '<p>2025-07-02</p>' "$repo_root/dist/index.html"
...
grep -q '<p>2025-07-03</p>' "$repo_root/dist/enoki-postmortem/index.html"
